    ...
    <div className="container mx-auto 2xl:px-32 px-4 mt-8">
      <div className="flex flex-col md:flex-row gap-4">
        {cards.length && cards.map((card) => (
          <div className='flex flex-col flex-[1] md:rounded-lg text-center px-4 pt-[60px] pb-10 bg-white shadow-sm' key={card.id}>
            <img src={card.image} alt={card.title} className='h-[150px]' />
