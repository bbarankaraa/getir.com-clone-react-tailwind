      ...
      <div className="container mx-auto 2xl:px-32">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-gray-200 mt-6 py-6 bg-gray-100 md:bg-white">
          <div className="text-xs text-gray-700 flex md:flex-row flex-col text-center gap-x-8">
            © 2025 Getir
            <a href="#" className="text-brand-color text-[13px] md:mt-0 mt-1 md:mb-0 mb-2">
              Bilgi Toplumu Hizmetleri
            </a>
          </div>
          <nav className="flex gap-2.5 text-paragraph">
            <a href="#" className="w-8 h-8 rounded-lg text-paragraph hover:bg-brand-color hover:bg-brand-color/10 hover:text-primary-color transition-colors flex items-center justify-center">
              <FaFacebook size={21} />
            </a>
            <a href="#" className="w-8 h-8 rounded-lg text-paragraph hover:bg-brand-color hover:bg-brand-color/10 hover:text-primary-color transition-colors flex items-center justify-center">
              <FaTwitter size={21} />
            ...
            <a href="#" className="h-8 flex items-center gap-x-2 rounded-lg bg-white text-paragraph px-2 text-sm border md:border-gray-100 border-gray-300 md:hover:bg-brand-color md:hover:bg-brand-color/10 hover:text-primary-color md:hover:border-transparent">
              <FiGlobe size={18} />
              Türkçe (TR)
            </a>
          </nav>
